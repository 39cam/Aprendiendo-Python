...
mensaje = input("Ingresa el mensaje a enviar al cliente: ")
...
while True:
    ...
    conn.sendall(f"{mensaje}".encode()) # Se envía el mensaje codificado al cliente para confirmar la conexión
